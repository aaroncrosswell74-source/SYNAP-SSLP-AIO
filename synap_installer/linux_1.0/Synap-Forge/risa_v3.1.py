...
try:
    ...
    print("⚠️ service_discovery.py not found - service_mapping detection disabled")
...
class ServiceMappingValidator:
    ...
    def _validate_interceptor(self):
        ...
        interceptor_path = BASE_DIR / "mcp" / "interceptor.py"
        if not interceptor_path.exists():
            interceptor_path = BASE_DIR / "interceptor.py"
            if not interceptor_path.exists():
