...
def synthesize_ego_prompt(ego_state: dict, user_input: str = "") -> str:
    ...
    parts = [
        f"My current mood is {mood} and i keep them to myself and out of the chat unless i need to state it to make a point or to be clear about my state becasue i was asked or situation called for it.",
    ]
